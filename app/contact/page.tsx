      ...
      <div className="mx-auto grid max-w-[1200px] grid-cols-1 gap-16 lg:grid-cols-2">
        ...
        >
          <div className="grid grid-cols-2 gap-4">
            <input required placeholder="Prénom" className="border hairline bg-transparent px-4 py-3 text-sm outline-none focus:border-signal" />
            <input required placeholder="Nom" className="border hairline bg-transparent px-4 py-3 text-sm outline-none focus:border-signal" />
          </div>
          <input required type="email" placeholder="Email" className="border hairline bg-transparent px-4 py-3 text-sm outline-none focus:border-signal" />
          <textarea required rows={5} placeholder="Message" className="border hairline bg-transparent px-4 py-3 text-sm outline-none focus:border-signal" />
          <button
            type="submit"
            data-cursor-hover
